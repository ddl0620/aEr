# Summer temperature anomalies - Data package

This data package contains the data that powers the chart ["Summer temperature anomalies"](https://ourworldindata.org/grapher/summer-temperature-anomalies?v=1&csvType=full&useColumnShortNames=false) on the Our World in Data website.
